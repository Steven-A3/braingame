...
export function SocialShareButtons({ text, url = 'https://dailybrain.one' }: SocialShareButtonsProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="text-sm text-slate-400 text-center">Share your score</p>
      <div className="flex justify-center gap-3">
        {socialLinks.map((social, index) => (
          <motion.button
            ...
            className={`${social.color} p-3 rounded-full text-white transition-all transform hover:scale-110 active:scale-95`}
        ...
        <motion.button
          ...
          onClick={handleCopy}
          className="bg-slate-700 hover:bg-slate-600 p-3 rounded-full text-white transition-all transform hover:scale-110 active:scale-95"
